...
In plaats van zelf alle CSS te schrijven, geef je je HTML-elementen classes van Bootstrap.
...
NOTE: Om Bootstrap goed te begrijpen, moet je de hoofdstukken HTML basis en CSS kennen. Bootstrap gebruikt zelf flexbox, media queries en het boxmodel.
...
Gebruik daarna een icoon met een `i`-element:
