...
* tags positioneren met `position`, en effecten zoals cirkels, doorzichtigheid, schaduwen en kleurverlopen gebruiken;
* tags naast elkaar plaatsen met flexbox en grid;
...
| Tags gewoon onder of naast elkaar zetten | geen `position`: gebruik de normale flow, flexbox of grid
|===

TIP: Gebruik `position` niet om een volledige pagina op te bouwen. Voor kolommen en rijen zijn flexbox en grid veel geschikter. `position` gebruik je voor tags die *bovenop* of *buiten* de normale indeling moeten staan.
